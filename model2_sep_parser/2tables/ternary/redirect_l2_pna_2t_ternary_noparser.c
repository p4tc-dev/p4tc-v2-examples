...
bpf_skb_p4tc_tbl_lookup(struct __sk_buff *skb,
...
struct __attribute__((__packed__)) ingress_nh_table2_value {
    ...
    union {
        ...
        struct __attribute__((__packed__)) { u32 port; u64 smac;
            u64 dmac;
        } ingress_send_nh;
        struct {
        } ingress_default_drop;
...
/* nh_table1_0.apply() */
            {
                 ...
                 */
                act_bpf = bpf_skb_p4tc_tbl_lookup(skb, &params_table1, &key, sizeof(key));
...
/* nh_table2_0.apply() */
                {
                     ...
                     */
                    key.keysz = 64;
                    act_bpf = bpf_skb_p4tc_tbl_lookup(skb, &params_table2, &key, sizeof(key));
...
int tc_ingress_func(struct __sk_buff *skb) {
    ...
    struct pna_main_output_metadata_t ostd = {
            .class_of_service = 0,
    };
